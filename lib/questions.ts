...
export const QUESTIONS: Question[] = [
  {
    ...
    groups: {
      Clothes: ["clothes", "clothing", "shirt", "pants", "underwear", "socks", "jacket", "sweater", "dress", "shorts", "pajamas", "outfit"],
      "Phone charger": ["charger", "phone charger", "charging cable", "cord", "cable", "power bank", "adapter"],
      Toiletries: ["toiletries", "toothbrush", "toothpaste", "deodorant", "shampoo", "razor", "floss", "hairbrush", "comb", "makeup"],
      Medication: ["medication", "medicine", "meds", "pills", "prescription", "inhaler", "vitamins"],
